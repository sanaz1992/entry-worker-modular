            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>@lang('user::attributes.users_edit') {{$user->full_name}} </h4>
                    </div>
                    @if ($message)
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        wire:model="form.mobile" @if($form['mobile_verified_at']) disabled @endif
                                        required>
                                    @error('form.mobile')
                                        <div class="error">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        wire:model="form.email" @if($form['email_verified_at']) disabled @endif>
                                    @error('form.email')
                                        <div class="error">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    @else
                                        <img src="{{ $user->avatar?->getThumbnailUrl('small') }}" class="mr-3 rounded"
                                            width="100">
                                    @endif
                                </div>
                            </div>
