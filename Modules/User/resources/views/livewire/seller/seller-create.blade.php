<div class="p-6 bg-white">
    ...
    <h2 class="text-2xl font-bold mb-4">{{ __('user::attributes.create') }} {{ __('user::attributes.seller') }}</h2>
    ...
    <form wire:submit="store">
        ...
        <div class="mb-4">
            ...
            <input type="text" wire:model.defer="form.address" class="border border-gray-300 rounded px-3 py-1 w-full" />
            @error('form.address')
                <span class="text-red-500 text-xs">{{ $message }}</span>
            @enderror
        </div>
        <div class="mb-4">
            ...
            <input type="text" wire:model.defer="form.postal_code" class="border border-gray-300 rounded px-3 py-1 w-full" />
